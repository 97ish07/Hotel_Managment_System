        ...
        <div class="background">
            ...
            <div class="formbackground">
                ...
                <form action="add_inventory" method="POST" id="submit_form">
                    ...
                    <div class="ItemName"><input type="text" name="ItemName" placeholder="Enter Item Name"
                            class="texbox"></div></br>
                    <div class="error2"><span>@error('ItemName'){{$message}}@enderror</span></div></br></br>
                    <label class="l3"><span>*</span> Supplire Name</label>
                    <div class="SupplireName"><input type="text" name="SupplireName" placeholder="Enter Supplire Name"
                            class="texbox"></div></br>
                    <div class="error3"><span>@error('SupplireName'){{$message}}@enderror</span></div></br></br>
                    <label class="l4"><span>*</span> Unit Price</label>
                    <div class="UnitPrice"><input id="numb" type="text" name="UnitPrice"
                            placeholder="Enter Unit Price(Rs)" class="texbox"></div></br>
                    <div class="error4"><span>@error('UnitPrice'){{$message}}@enderror</span></div></br></br>
                    <p id="demo"></p>
                    <label class="l5"><span>*</span> Quantity</label>
                    <div class="Quantity"><input type="text" name="Quantity" placeholder="Enter Quantity"
                            class="texbox"></div></br>
                    <div class="error5"><span>@error('Quantity'){{$message}}@enderror</span></div></br></br>
                    <label class="l6"><span>*</span> Description</label>
                    <div class="Description"><input type="text" name="Description" placeholder="Description"
                            class="texbox"></div></br>
                    <div class="error6"><span>@error('Description'){{$message}}@enderror</span></div></br></br>
                    <button onsubmit="myFunction()" type="submit" class="submitbtn"> Submit</button>
                    <div id="app">
