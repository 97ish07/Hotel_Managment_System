                ...
                <div class="back">
                    ...
                    <form action="/action_page.php" class="form-container">
                        ...
                        <div class="popupbox">
                            ...
                            <button type="submit" class="btn">@foreach($inventory_keys as $inventoryss)<span>
                                    <td><a class="textdec"
                                            href={{"DeleteInventoryData/".$inventoryss['id']}}>@endforeach Delete</a>
                                    </td>
                                </span></button>

                            <button type="button" class="btncancel" onclick="closeForm()">Close</button>
                            <button type="button" class="btncance3" onclick="closeForm()"><span
                                    class="btnpopuplogo1"></span></button>
                        </div>
                    </form>
                </div>
            ...
            <div class="viewintable">
                <table id="viewtable">
                    ...
                    <tr class="tablehead2">
                        ...
                        <td><button class="dltbtn" onclick="openForm()">
